...
[BlockInfo(1.0,0.5,0.5,0.8, 1, indent)] dummy_main ("Main settings", Float) = 1    
        ...
        [HideByProp(_IBLSpec, dummy_main)] _SpecIBLMulti("         Ambient Reflection Multi", Float) = 1[HideByProp(dummy_main)] _AmbientIBL ("         Ambient > diff IBL", Range(0, 1)) = 1
...
//            #define SHADOWS_OFF
            ...
            // ============================================================================================================================================================================================================================================
			// Warning On Import about "floating point division by zero at UnityCG.cginc(193) (on d3d11)" is a Unity Issue... cannot be resolved as it would need a change in UnityCG.cginc on your side(use Unity_SafeNormalize() instead of Normalize())!
			// ============================================================================================================================================================================================================================================
