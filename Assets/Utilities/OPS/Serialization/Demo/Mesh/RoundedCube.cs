...
/// <summary>
/// Attach it to an GameObject, containing a MeshFilter, Meshrenderer.
/// The MonoBehaviour creates random rounded cube meshed.
/// Besides creating meshes, it can also load a saved mesh and apply it.
/// </summary>
...
public class RoundedCube : MonoBehaviour {
    ...
    /// <summary>
    /// Load a saved Mesh and apply it to the MeshFilter and MeshCollider.
    /// </summary>
    /// <param name="mesh"></param>
    public void Load(Mesh mesh)
    {
        GetComponent<MeshFilter>().mesh = mesh;
        this.AddBoxCollider(mesh.bounds.size.x, mesh.bounds.size.y, mesh.bounds.size.z);
    }

    /// <summary>
    /// Generate a Mesh basing on xSize, ySize, zSize and the roundness.
    /// </summary>
