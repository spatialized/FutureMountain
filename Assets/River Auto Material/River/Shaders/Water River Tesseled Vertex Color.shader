Shader "NatureManufacture Shaders/Water River Tesseled Vertex Color"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata v )
		{
			...
			float temp_output_414_0 = ( ( tex2Dlod( _SmallCascadeWaterTess, half4( SmallCascadeSpeedValueMix433, 0.0 , 0.0 ) ).r * _SmallCascadeWaterTessScale ) + ( tex2Dlod( _SmallCascadeWaterTess, half4( SmallCascadeSpeedValueMain600, 0.0 , 0.0 ) ).r * _SmallCascadeWaterTessScale ) );
			...
			float temp_output_565_0 = ( ( _BigCascadeWaterTessScale * tex2Dlod( _BigCascadeWaterTess, half4( BigCascadeSpeedValueMix608, 0.0 , 0.0 ) ).r ) + ( _BigCascadeWaterTessScale * tex2Dlod( _BigCascadeWaterTess, half4( BigCascadeSpeedValueMain432, 0.0 , 0.0 ) ).r ) );
