...
namespace DynamicFogAndMist {
    ...
    public class DynamicFogEditor : Editor {
        ...
        SerializedProperty heightFallOff, baselineHeight, clipUnderBaseline, turbulence, speed, windDirection, color, color2, skyboxBlending;
        ...
        void OnEnable() {
            ...
            skyboxBlending = serializedObject.FindProperty("_skyboxBlending");
        ...
        public override void OnInspectorGUI() {
            ...
            if (expandSection[FOG_PROPERTIES]) {
                ...
                EditorGUILayout.PropertyField(skyboxBlending);
            }

            if (!skyboxBlending.boolValue) {
