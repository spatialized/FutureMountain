...
namespace DynamicFogAndMist {
    ...
    public class DynamicFogOfWar : MonoBehaviour {
        ...
        void Update() {
            fogMat.SetVector(DynamicFogBase.ShaderParams.FoWData, new Vector4(transform.position.x, transform.position.z, transform.localScale.x, transform.localScale.y));
        }
