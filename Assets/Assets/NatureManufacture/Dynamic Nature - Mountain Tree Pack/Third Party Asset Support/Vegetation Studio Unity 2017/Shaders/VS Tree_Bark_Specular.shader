// Upgrade NOTE: upgraded instancing buffer 'NatureManufactureShadersVSTreeBarkSpecular' to new syntax.

Shader "NatureManufacture Shaders/VS Tree Bark Specular"
{
	Properties
	{
	...
	SubShader
	{
		...
		UNITY_INSTANCING_BUFFER_START(NatureManufactureShadersVSTreeBarkSpecular)
			UNITY_DEFINE_INSTANCED_PROP(fixed, _SpecularPower)
#define _SpecularPower_arr NatureManufactureShadersVSTreeBarkSpecular
			UNITY_DEFINE_INSTANCED_PROP(fixed, _SmothnessPower)
#define _SmothnessPower_arr NatureManufactureShadersVSTreeBarkSpecular
			UNITY_DEFINE_INSTANCED_PROP(fixed, _AmbientOcclusionPower)
#define _AmbientOcclusionPower_arr NatureManufactureShadersVSTreeBarkSpecular
		UNITY_INSTANCING_BUFFER_END(NatureManufactureShadersVSTreeBarkSpecular)
