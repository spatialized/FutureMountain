// Upgrade NOTE: upgraded instancing buffer 'NatureManufactureShadersVSTreeBarkMetalic' to new syntax.

 Shader "NatureManufacture Shaders/VS Tree Bark Metalic"
{
	Properties
	{
	...
	SubShader
	{
		...
		UNITY_INSTANCING_BUFFER_START(NatureManufactureShadersVSTreeBarkMetalic)
			UNITY_DEFINE_INSTANCED_PROP(fixed, _MetalicPower)
#define _MetalicPower_arr NatureManufactureShadersVSTreeBarkMetalic
			UNITY_DEFINE_INSTANCED_PROP(fixed, _SmothnessPower)
#define _SmothnessPower_arr NatureManufactureShadersVSTreeBarkMetalic
			UNITY_DEFINE_INSTANCED_PROP(fixed, _AmbientOcclusionPower)
#define _AmbientOcclusionPower_arr NatureManufactureShadersVSTreeBarkMetalic
		UNITY_INSTANCING_BUFFER_END(NatureManufactureShadersVSTreeBarkMetalic)
