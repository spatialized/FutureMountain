...
--
-- Host: 127.0.0.1    Database: futuremtn_central_coast_v3
-- ------------------------------------------------------
...
CREATE TABLE `cubedata` (
  ...
  `gppOver` float NOT NULL,
  `respOver` float NOT NULL,
  ...
  `gppUnder` float NOT NULL,
  `respUnder` float NOT NULL,
  ...
  `fire` float NOT NULL,
  PRIMARY KEY (`id`),
  KEY `IX_CubeData_scenarioRunId_scenarioIdx_dateIdx_zoneID_patchID` (`scenarioRunId`,`scenarioIdx`,`dateIdx`,`zoneID`,`patchID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-07-04 17:31:49
