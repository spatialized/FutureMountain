...
{
    /// <summary>
    /// Database context for the Central Coast v3 profile.
    ///
    ...
    /// Central Coast v3 naming style.
    /// </summary>
    public class CentralCoastV3DbContext : DbContext
    {
        private readonly string _connectionString;

        public CentralCoastV3DbContext() : this(ConnectionHelper.GetConnectionString())
        {
        }

        public CentralCoastV3DbContext(string connectionString)
        {
        ...
        public DbSet<CubeDataRowV3> CubeData { get; set; }
