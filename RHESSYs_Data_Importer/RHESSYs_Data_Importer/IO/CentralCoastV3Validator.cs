...
{
    /// <summary>
    /// Validates Central Coast v3 source files before import.
    ///
    ...
    /// </summary>
    public static class CentralCoastV3Validator
    {
        ...
        private static readonly int[] ExpectedZoneIDs = new[] { 6487, 18030, 14094, 13260, 20803 };
        // private static readonly int cubeAggregateDailyCount = 11688;
        // private static readonly int cubePatch01DailyCount = 58440;
        // private static readonly int cubePatch02DailyCount = 58440; 
        ...
        public static ValidationReport Validate(ScenarioConfig config)
        {
            ...
            report.Info.Add($"ScenarioRunId: {config.ScenarioRunId}, ScenarioIdx: {config.ScenarioIdx}");
        ...
        private static long GetExpectedRowCount(string role)
        {
            return role.ToLowerInvariant() switch
            {
                ...
                "allpatchmonthly01"  => 1719168,
                "allpatchmonthly02"  => 1719168,
        ...
        private static Dictionary<string, int> BuildColumnIndexMap(string[] headers)
        {
            ...
            for (int i = 0; i < headers.Length; i++)
                map[headers[i].Trim().Trim('"').ToLowerInvariant()] = i;
            return map;
        }
